...
Данная директория содержит результаты проведенных экспериментов с кодом из статьи [Optimal Brain Compression](arxiv.org/pdf/2208.11580). Основная задача: повторить результаты авторов статьи и убедиться в их достоверности и актуальности.
